...
function register() {
    ...
    if (regname == "USERNAME" || regname == "") {
        document.getElementById("reghint1").innerHTML = "请输入用户名！";
        exit(1);
    }
    if (regemail == "邮箱(abc@abc.com)" || regemail == "") {
        document.getElementById("reghint2").innerHTML = "请输入邮箱！";
        exit(1);
    }
    if (regpassword == "********" || regpassword == "") {
        document.getElementById("reghint3").innerHTML = "请输入密码！";
        exit(1);
    }
