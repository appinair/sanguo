...
function download(page)
{
    ...
    try
    {   
     var url="download.php?username="+username+"&page="+page
...
function login(x)                   //x==1,from button;x==2,from register;x==0,from pageload;
{
	...
	if(x==1){
		if(username=="USERNAME"||username==""){document.getElementById("loginhint1").innerHTML="请输入用户名！";exit(1);}
		if(password=="********"||password==""){document.getElementById("loginhint2").innerHTML="请输入密码！";exit(1);}
...
if (username!=null && username!="")
  ...
  document.getElementById("logindiv").href="logout.php";
...
function refreshdata()
{
	...
	if(zhaomu[i]<10000){document.getElementById("guyong"+i).disabled = true;}
	...
	switch(xmlDoc.getElementsByTagName("class")[lv(zhaomu[i])].childNodes[0].nodeValue){
		case '0':document.getElementById("myAnchor"+i).style.color="#FFD306";break;
		case '1':document.getElementById("myAnchor"+i).style.color="#CE0000";break;
		case '2':document.getElementById("myAnchor"+i).style.color="#0000C6";break;
		case '3':document.getElementById("myAnchor"+i).style.color="#009100";break;
		case '4':document.getElementById("myAnchor"+i).style.color="#fff";break;
	}
	}
	}
